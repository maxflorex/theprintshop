        ...
        <div style={{marginRight: '2rem', marginLeft: '2rem'}}>
            <Items3 m="0" gap="2rem" p="0">
                <Flex
                    className="bg-white"
                    color={`${
                        selected === 'stretchers' ? 'var(--off2)' : 'white'
                    }`}
                    cursor="pointer"
                    m="0"
                    onClick={() => setSelectedTab('stretchers')}
                >
                    <Title size="2rem">Stretcher Bars</Title>
                </Flex>
                <Flex
                    className="bg-white"
                    color={`${selected === 'wrap' ? 'var(--off2)' : 'white'}`}
                    cursor="pointer"
                    m="0"
                ...
                <Flex
                    className="bg-white"
                    color={`${
                        selected === 'floaters' ? 'var(--off2)' : 'white'
                    }`}
                    cursor="pointer"
                    m="0"
                    onClick={() => setSelectedTab('floaters')}
                >
