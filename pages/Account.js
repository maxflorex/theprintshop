                ...
                (
                    <Flex color='none' img={link} attach='fixed' m='0'>
                        <Column m='0' p='2rem' items='start'>
                            ...
                            <BtnBlack w='100%' onClick={logout}>Sign Out</BtnBlack>
                        </Column>
                        <Column colorH='var(--accent)' p='2rem' cursor='pointer' onClick={() => setShowOrders(!showOrders)}>
                            <FiFileText style={{ width: '4rem', height: '4rem', color: 'white' }} />
                            <Title font='Roboto' size='1rem' color='white' w='600' >My Orders</Title>
                        </Column>
                    </Flex>
                )}
